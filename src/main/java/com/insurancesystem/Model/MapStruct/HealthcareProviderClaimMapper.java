...
public interface HealthcareProviderClaimMapper {
    ...
    @Mapping(target = "providerRole", expression = "java(claim.getHealthcareProvider() != null && claim.getHealthcareProvider().getRequestedRole() != null ? claim.getHealthcareProvider().getRequestedRole().name() : null)")
    @Mapping(source = "healthcareProvider.employeeId", target = "providerEmployeeId")
